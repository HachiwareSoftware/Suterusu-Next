...
namespace Suterusu.Tests
{
    public class NotificationFactoryTests
    {
        ...
        {
            var service = NotificationServiceFactory.Create(NotificationMode.FlashWindow);
        ...
        {
            var service = NotificationServiceFactory.Create(NotificationMode.CircleDot);
        ...
        {
            var service = NotificationServiceFactory.Create(NotificationMode.Nothing);
        ...
        {
            INotificationService flash  = NotificationServiceFactory.Create(NotificationMode.FlashWindow);
            INotificationService circle = NotificationServiceFactory.Create(NotificationMode.CircleDot);
            INotificationService none   = NotificationServiceFactory.Create(NotificationMode.Nothing);
